...
{
	/*надо сделать 
	генерация всех команд для кадого проц, в том числе команд, требующих обращение к памяти
	мб матрица (команды/проц/идентификатор нужно обращение или нет)
	*/
	...
	//пока что вручную с учётом того, что 80% без обращения к памяти
